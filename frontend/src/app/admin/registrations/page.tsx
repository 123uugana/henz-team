...
import { setRegistrationStatus, useRegistrations } from "@/lib/store";
...
export default function AdminRegistrationsPage() {
  const [registrations, refresh] = useRegistrations();
          ...
          <Card key={reg.id} className="gap-3 bg-[#141a2c] p-4 ring-1 ring-white/5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex min-w-0 flex-1 flex-col">
                ...
                <p className="text-xs text-gray-600">{reg.requestedAt}</p>
              </div>
